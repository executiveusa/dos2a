  ...
  return (
    <footer className="site-footer">
      <div className="site-footer__grid">
        <div className="brand-lockup brand-lockup--footer"><strong>dos A</strong><span>{siteContent.brand.tagline[lang]}</span></div>
        ...
        <p className="footer-note">{lang === "es" ? "Ciudad de México · proyectos en todo México" : "Mexico City · projects across Mexico"}</p>
      </div>
