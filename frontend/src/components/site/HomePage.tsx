...
export default function HomePage() {
  ...
  return <PublicShell>
    ...
    <section id="brief" className="brief-section"><div className="brief-mark" aria-hidden="true"><BrandMark className="brief-brand"/></div><div><p className="eyebrow">{c.brief.eyebrow[lang]}</p><h2>{c.brief.title[lang]}</h2><p>{c.brief.body[lang]}</p><Link className="button button--light" href="/cotizar#brief"><MessageCircle size={18}/>{c.brief.cta[lang]}</Link></div></section>
