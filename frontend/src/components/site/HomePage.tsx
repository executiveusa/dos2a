  ...
  return <PublicShell>
    <section className="hero-orientation">
      ...
      <div className="hero-orientation__content">
        ...
        <div className="button-row"><Link className="button button--light" href="/cotizar">{c.hero.primary[lang]} <ArrowRight size={17}/></Link><Link className="text-link hero-secondary" href="/portafolio">{c.hero.secondary[lang]}<ArrowRight size={17}/></Link><p className="trust-line">{c.hero.proof[lang]}</p></div>
      </div>
    </section>
    ...
    <section id="la-genio" className="genio-section"><div className="genio-mark" aria-hidden="true"><BrandMark className="genio-brand"/></div><div><p className="eyebrow">{c.genio.eyebrow[lang]}</p><h2>{c.genio.title[lang]}</h2><p>{c.genio.body[lang]}</p><Link className="button button--light" href="/cotizar#la-genio"><MessageCircle size={18}/>{c.genio.cta[lang]}</Link></div></section>
