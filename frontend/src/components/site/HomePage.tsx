...
const homeServices: Array<{ n: string; title: Bilingual }> = [
  ...
  { n: "02.", title: { es: "Video y Pantallas LED.", en: "Video and LED screens" } },
  { n: "03.", title: { es: "Escenarios y Stands.", en: "Stages and stands" } },
  { n: "04.", title: { es: "Operación y Coordinación.", en: "Operation and coordination" } },
  { n: "05.", title: { es: "Servicios Especiales.", en: "Special services" } },
];
