...
export default function QuoteForm() {
  ...
  return (
    <form className="quote-form" onSubmit={submit}>
      ...
      <div className="field-grid">
        <label><span>{lang === "es" ? "Fecha del evento (si ya la tienes)" : "Event date (if you have one)"}</span><input name="date" type="date" lang="es-MX" value={form.date} onChange={change}/></label>
