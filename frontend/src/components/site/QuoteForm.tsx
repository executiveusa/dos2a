...
export default function QuoteForm() {
  ...
  return (
    <form className="quote-form" onSubmit={submit}>
      ...
      <label><span>{lang === "es" ? "¿Qué quieres lograr o qué necesitas?" : "What do you need to accomplish?"}</span><textarea name="needs" rows={6} value={form.needs} onChange={change} placeholder={lang === "es" ? "Cuéntanos la idea con tus propias palabras. No necesitas saber términos técnicos." : "Describe the idea in your own words. You do not need technical terms."}/></label>
